...
import 'package:internlink_flutter_application/features/admin/presenation/screens/admin_dashboard.dart';
import 'package:internlink_flutter_application/features/admin/presenation/screens/status_determiner_screen.dart';
...
import 'package:internlink_flutter_application/features/student/presentation/screens/apply_internship_screen.dart';
...
import 'package:internlink_flutter_application/features/common/landing_screen.dart'; // Make sure to import your LandingPage here
...
final routerProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    redirect: (context, state) async {
      ...
      if (token == null) {
        if (publicRoutes.contains(state.uri.path)) return null;
        return '/login';
      }
    ...
    routes: [
      GoRoute(
        ...
        pageBuilder: (context, state) => MaterialPage(
          key: state.pageKey,
          child: const LandingPage(), // Ensure you have LandingPage implemented
        ),
      ),
      GoRoute(
        path: '/login',
      ...
      GoRoute(
        ...
        pageBuilder: (context, state) => MaterialPage(
          key: state.pageKey,
          child: const SignUpScreen(),// SignUpScreen
        ),
      ),
            ...
            pageBuilder: (context, state) {
              ...
              return MaterialPage(
                ...
                child: internship == null
                    ? const Scaffold(body: Center(child: Text('Internship data not available')))
          ...
          GoRoute(
            ...
            pageBuilder: (context, state) {
              ...
              if (internshipId == null || int.tryParse(internshipId) == null) {
                return MaterialPage(
                  key: state.pageKey,
                  child: const Scaffold(body: Center(child: Text('Invalid internship ID'))),
                );
              }
              return MaterialPage(
                key: state.pageKey,
                child: CreateApplicationScreen(internshipId: int.parse(internshipId)),
              );
            },
          ),
          GoRoute(
